 ...
 * focus ring at all and set focus:outline-hidden on its password input, which
...
export const FOCUS_RING =
  'focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 dark:focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-zinc-950 rounded-xs';
